...
@integration @del_simulacoes @sucessful @smoke
...
@integration @del_simulacoes @alternative @issue-1987 @incorrect_status_code
Scenario: Removendo simulacao inexistente
